...
class RAGConfig:
    ...
    vector_store_type: str = "qdrant"  # "local" or "qdrant" - default to Qdrant for production
    ...
    embedding_health_check_interval: int = 300  # 5 minutes
    embedding_fallback_enabled: bool = True
    text_search_fallback_enabled: bool = True
...
class RAGConfigManager:
    ...
    def _load_config(self) -> RAGConfig:
        ...
        return RAGConfig(
            ...
            # Vector Store Configuration
            vector_store_type=os.getenv('RAG_VECTOR_STORE_TYPE', 'local').lower(),
            ...
            qdrant_collection_name=os.getenv('QDRANT_COLLECTION_NAME', 'faq_embeddings'),
            qdrant_timeout=int(os.getenv('QDRANT_TIMEOUT', '30')),
            
            # Embedding Health and Fallback Configuration
            embedding_health_check_interval=int(os.getenv('RAG_EMBEDDING_HEALTH_CHECK_INTERVAL', '300')),
            embedding_fallback_enabled=os.getenv('RAG_EMBEDDING_FALLBACK_ENABLED', 'true').lower() == 'true',
            text_search_fallback_enabled=os.getenv('RAG_TEXT_SEARCH_FALLBACK_ENABLED', 'true').lower() == 'true',
            embedding_retry_attempts=int(os.getenv('RAG_EMBEDDING_RETRY_ATTEMPTS', '3')),
            embedding_retry_delay=float(os.getenv('RAG_EMBEDDING_RETRY_DELAY', '1.0')),
    ...
    def get_vector_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'qdrant_port': self._config.qdrant_port,
            'qdrant_collection_name': self._config.qdrant_collection_name,
            'qdrant_timeout': self._config.qdrant_timeout,
        }
